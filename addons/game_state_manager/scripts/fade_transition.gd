...
@export var transition_speed_in : float = 0.5
@export var transition_speed_out : float = 0.5
...
func _trigger_transition_in() -> void:
	...
	tween.tween_property(color_rect, "color", Color(transition_color.r,transition_color.g,transition_color.b,1), transition_speed_in)
...
func _trigger_transition_out() -> void:
	tween = create_tween()
	tween.set_ease(Tween.EASE_IN)
	tween.tween_property(color_rect, "color", Color(transition_color.r,transition_color.g,transition_color.b,0), transition_speed_out)
